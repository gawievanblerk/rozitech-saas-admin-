...
from .models import Organization as Tenant, Domain, OrganizationUser as TenantUser
...
class TenantCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'city', 'country', 'company_registration', 'industry',
            'tier', 'primary_domain'
        ]
...
class TenantUserSerializer(serializers.ModelSerializer):
    ...
    tenant_name = serializers.CharField(source='organization.name', read_only=True)
    
    class Meta:
        model = TenantUser
        fields = [
            'id', 'organization', 'tenant_name', 'user', 'role', 'is_active',
